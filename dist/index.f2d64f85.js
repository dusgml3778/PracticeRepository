...
})({"2ZSXP":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "f8207c58f2d64f85";
"use strict";
...
},{}],"cx5r7":[function(require,module,exports) {
...
console.log('uniqBy', _lodashDefault.default.uniqBy(userC, 'userid'));
// 중복되는 값이 있는 객체,중복되는 값의 속성
// 배열 데이터가 하나 일 때 
const userD = _lodashDefault.default.unionBy(userA, userB, 'userid');
// 배열 데이터가 여러 개 일때
...
const founder = _lodashDefault.default.find(users, {
    name: 'A'
});
console.log(founder);
const founderIndex = _lodashDefault.default.findIndex(users, {
    name: 'D'
});
console.log(founderIndex);
_lodashDefault.default.remove(users, {
    name: 'B'
});
console.log(users);

},{"lodash":"f4H2C","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"f4H2C":[function(require,module,exports) {
...
},{}]},["2ZSXP","cx5r7"], "cx5r7", "parcelRequire1fd4")

//# sourceMappingURL=index.f2d64f85.js.map
